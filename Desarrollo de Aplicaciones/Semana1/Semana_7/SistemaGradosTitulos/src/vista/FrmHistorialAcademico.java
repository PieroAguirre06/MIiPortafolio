...
public class FrmHistorialAcademico extends JFrame {
    ...
    public FrmHistorialAcademico() {
        ...
        cargarTabla();
        cargarCombos();
        setTitle("Historial Académico - UPLA");
        setSize(750, 550);
    ...
    private void initComponents() {
        ...
        add(header);
        JLabel lbl = new JLabel("HISTORIAL ACADÉMICO", SwingConstants.CENTER);
        ...
        cmbPrograma.setBounds(560, y, 160, 25);
        add(cmbPrograma);
        ...
        agregarLabel("Fecha Egreso:", 330, y);
        txtFechaEgreso = new JTextField();
        txtFechaEgreso.setBounds(430, y, 120, 25);
        txtFechaEgreso.setBorder(BorderFactory.createLineBorder(Color.GRAY));
        add(txtFechaEgreso);

        agregarLabel("Fecha Bachiller:", 570, y);
        txtFechaBachiller = new JTextField();
        txtFechaBachiller.setBounds(680, y, 50, 25);
        ...
        scroll.setBounds(10, 180, 725, 320);
        add(scroll);
    ...
    private void guardar() {
        try {
            String sql = "INSERT INTO historial_academico (codigo_estudiante, id_programa, condicion_actual, fecha_egreso, fecha_bachiller) VALUES (?,?,?,?,?)";
    ...
    private void editar() {
        ...
        try {
            String sql = "UPDATE historial_academico SET condicion_actual=?, fecha_egreso=?, fecha_bachiller=? WHERE id_historial=?";
            PreparedStatement ps = con.prepareStatement(sql);
