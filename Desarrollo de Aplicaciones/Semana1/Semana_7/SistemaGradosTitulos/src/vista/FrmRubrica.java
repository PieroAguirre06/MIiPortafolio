...
public class FrmRubrica extends JFrame {
    ...
    public FrmRubrica() {
        ...
        initComponents();
        cargarTabla();
        setTitle("Rúbricas de Evaluación - UPLA");
        setSize(750, 550);
    ...
    private void initComponents() {
        ...
        add(header);
        JLabel lbl = new JLabel("RÚBRICAS DE EVALUACIÓN", SwingConstants.CENTER);
