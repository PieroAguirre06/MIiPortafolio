...
public class TramiteController {
    ...
    public List<String> listarEstudiantesConNombre() {
        ...
        try {
            String sql = "SELECT u.codigo, u.nombres, u.apellidos " +
                         "FROM usuario u WHERE u.rol='Estudiante' AND u.estado='Activo' ORDER BY u.apellidos";
