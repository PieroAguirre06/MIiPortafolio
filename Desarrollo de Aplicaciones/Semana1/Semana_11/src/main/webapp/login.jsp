...
<body>
    ...
    <div class="header-container">
        <div class="header-left">
            <img src="images/logo-izquierdo.png" alt="Logo" class="header-logo">
        </div>
        <div class="header-center">
            <div class="header-title">QhatuPERU</div>
            <div class="header-subtitle">Sistema de Gestión de Tiendas</div>
        ...
        <div class="header-right">
            <img src="images/logo-derecho.png" alt="Logo" class="header-logo">
        </div>
    </div>
    ...
    <div class="login-container">
        ...
        <div class="footer">
            © 2026 · <span>QhatuPERU</span> · Sistema de Gestión
        </div>
    </div>
</body>
</html>