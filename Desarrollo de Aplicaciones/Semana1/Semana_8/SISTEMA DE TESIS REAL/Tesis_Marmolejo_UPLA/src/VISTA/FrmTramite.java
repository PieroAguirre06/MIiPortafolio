...
public class FrmTramite extends JFrame {
    ...
    public FrmTramite() {
        ...
        initComponents();
        cargarTabla();
        setTitle("Trámites - UPLA IBERCAP");
        setSize(750, 520);
    ...
    private void initComponents() {
        ...
        add(header);
        JLabel lbl = new JLabel("GESTIÓN DE TRÁMITES", SwingConstants.CENTER);
        ...
        cmbTipoTramite.setBounds(120, y, 250, 25);
        add(cmbTipoTramite);

        agregarLabel("Estado:", 400, y);
        ...
        cmbEstado.setBounds(460, y, 250, 25);
        add(cmbEstado);
        ...
        scroll.setBounds(10, 185, 725, 285);
        add(scroll);
