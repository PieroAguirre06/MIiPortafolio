...
public class FrmProgramaEstudios extends JFrame {
    ...
    public FrmProgramaEstudios() {
        ...
        cargarTabla();
        cargarFacultades();
        setTitle("Programas de Estudio - UPLA IBERCAP");
        setSize(850, 580);
    ...
    private void initComponents() {
        ...
        add(header);
        JLabel lbl = new JLabel("GESTIÓN DE PROGRAMAS DE ESTUDIO", SwingConstants.CENTER);
        ...
        cmbFacultad.setBounds(100, y, 400, 25);
        add(cmbFacultad);

        agregarLabel("Modalidad:", 540, y);
        cmbModalidad = new JComboBox<>(new String[]{"Presencial", "Semipresencial", "A_Distancia"});
        cmbModalidad.setBounds(620, y, 180, 25);
        add(cmbModalidad);

        y = 90;
        agregarLabel("Nombre Programa:", 20, y);
        txtNombre = new JTextField();
        txtNombre.setBounds(150, y, 650, 25);
        ...
        txtTitulo.setBounds(620, y, 180, 25);
        ...
        scroll.setBounds(10, 220, 825, 310);
        add(scroll);
    ...
    private void guardar() {
        ...
        try {
            PreparedStatement ps = con.prepareStatement("INSERT INTO programa_estudios (id_facultad, nombre, grado_academico, titulo_profesional, modalidad_estudio) VALUES (?,?,?,?,?)");
    ...
    private void editar() {
        ...
        try {
            PreparedStatement ps = con.prepareStatement("UPDATE programa_estudios SET id_facultad=?, nombre=?, grado_academico=?, titulo_profesional=?, modalidad_estudio=? WHERE id_programa=?");
            ps.setInt(1, obtenerIdFacultad());
            ps.setString(2, txtNombre.getText().trim());
            ps.setString(3, txtGrado.getText().trim());
            ps.setString(4, txtTitulo.getText().trim());
