...
public class FrmDocumento extends JFrame {
    private JComboBox<String> cmbTramite, cmbTipoDocumento, cmbEstadoValidacion;
    ...
    public FrmDocumento() {
        ...
        cargarTabla();
        cargarCombos();
        setTitle("Documentos de Trámite - UPLA IBERCAP");
        setSize(950, 620);
    ...
    private void initComponents() {
        ...
        add(header);
        JLabel lbl = new JLabel("GESTIÓN DE DOCUMENTOS DE TRÁMITE", SwingConstants.CENTER);
        ...
        cmbTramite.setBounds(100, y, 400, 25);
        add(cmbTramite);

        agregarLabel("Tipo Documento:", 530, y);
        ...
        cmbTipoDocumento.setBounds(650, y, 260, 25);
        ...
        btnSeleccionarArchivo.setBounds(660, y, 120, 25);
        btnSeleccionarArchivo.setBackground(new Color(26, 58, 107));
        ...
        agregarLabel("Observación:", 330, 130);
        ...
        scrollObs.setBounds(430, 130, 480, 60);
        add(scrollObs);
        ...
        scroll.setBounds(10, 250, 925, 320);
        add(scroll);
    ...
    private void seleccionarArchivo() {
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Documentos PDF, DOC, DOCX, JPG, PNG", "pdf", "doc", "docx", "jpg", "png");
        ...
        try {
            ...
            if (rs.next()) {
                ...
                for (int i = 0; i < cmbTramite.getItemCount(); i++) {
                    if (cmbTramite.getItemAt(i).startsWith(idTramite + " -")) {
