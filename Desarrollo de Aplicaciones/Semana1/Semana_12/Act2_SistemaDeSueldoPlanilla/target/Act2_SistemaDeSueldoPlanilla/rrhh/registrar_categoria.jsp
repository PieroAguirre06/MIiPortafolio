...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        select { width: 100%; padding: 10px; border: 1.5px solid #D1D5DB; border-radius: 8px; font-size: 15px; }
...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/rrhh" method="POST">
        <input type="hidden" name="action" value="guardarCategoria">
        <div class="form-group">
            <label>Seleccionar Categoría</label>
            <select name="categoria" required>
                <option value="">Seleccionar</option>
                <option value="A">Categoría A (S/45.00/hora)</option>
                <option value="B">Categoría B (S/37.50/hora)</option>
            </select>
        </div>
