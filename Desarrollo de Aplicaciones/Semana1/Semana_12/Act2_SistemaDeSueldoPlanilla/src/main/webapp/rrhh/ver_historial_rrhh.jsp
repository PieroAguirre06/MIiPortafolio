...
<head>
    <meta charset="UTF-8">
    <title>Historial de Cálculos - RRHH</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card { background: #F9FAFB; border-radius: 12px; padding: 16px; margin-bottom: 10px; border-left: 4px solid #059669; }
...
<body>
<div class="container">
    <h1>📊 Historial de Cálculos (RRHH)</h1>
